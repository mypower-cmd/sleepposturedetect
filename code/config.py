...
# cfg.train_dataset_path = "../process_data/train_alldata.tfrecords"
# cfg.val_dataset_path = "../process_data/val_alldata.tfrecords"
# cfg.train_num_samples_file_name = "../process_data/num_samples_data_all.npy"

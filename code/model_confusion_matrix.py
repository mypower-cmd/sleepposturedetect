...
path_tfrecords = '../process_data/val_nocontainmotion.tfrecords'
predict_model = tf.keras.models.load_model('../model/posture_classify_testacc94.23.h5', compile=True) #  注意这儿得compile需要设置为true，如果你不设置你需要多一步compile的过程。

...
def train_and_val(trial):
    ...
    val_data = train_dataset.take((cfg.train_num_samples*(cfg.val_rate))//cfg.batch_size)
    train_data = train_dataset.skip((cfg.train_num_samples*(cfg.val_rate))//cfg.batch_size)

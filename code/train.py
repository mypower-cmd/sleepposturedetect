...
def train_and_val():
    ...
    print('-----------test--------')
    test_loss, test_acc = model.evaluate(test_dataset, steps=(cfg.test_num_samples // cfg.batch_size), verbose=1)
...
if __name__ == '__main__':
    gennerate_terecord_file(cfg.train_dataset_path, cfg.val_dataset_path,  0, 56)
